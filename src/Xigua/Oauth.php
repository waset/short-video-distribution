...
class Oauth extends Application
{
     ...
     * 西瓜获取授权码(code)
     *
     * 该接口只适用于西瓜获取授权临时票据（code）
     *
     * 该URL不是用来请求的, 需要展示给用户用于扫码，在西瓜APP支持端内唤醒的版本内打开的话会弹出客户端原生授权页面。
     *
     * @see https://open-api.ixigua.com/platform/doc/6848806519174154248
     *
    ...
    {
        $api_url = self::BaseUrl . '/oauth/connect/';
        $params = [
            // 应用唯一标识
     ...
     * 该接口适用于西瓜授权
     *
     * @see https://open-api.ixigua.com/platform/doc/6848806493387606024
     *
     * @param string $code  授权码
     * @param string $model 请求类型
     * @param string $model.douyin 西瓜
     * @param string $model.Xigua 西瓜
     *
     * @return BaseApi
     */
