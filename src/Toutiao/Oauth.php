...
class Oauth extends Application
{
     ...
     *
     * 该URL不是用来请求的, 需要展示给用户用于扫码，在头条APP支持端内唤醒的版本内打开的话会弹出客户端原生授权页面。
     *
    ...
    {
        $api_url = self::BaseUrl . '/oauth/authorize/';
        $params = [
            // 应用唯一标识
     ...
     * 该接口适用于头条授权
     *
     * @see https://open.snssdk.com/platform/doc/6848806493387606024
     *
     * @param string $code  授权码
     * @param string $model 请求类型
     * @param string $model.douyin 头条
